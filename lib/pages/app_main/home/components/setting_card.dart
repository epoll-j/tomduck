...
class SettingCard extends StatelessWidget {
  ...
  final _itemList = [{'title': '证书配置', 'icon': IconFont.icon_https}, {'title': '过滤器', 'icon': IconFont.icon_guolvqi},{'title': '请求篡改', 'icon': IconFont.icon_xiugai},{'title': '请求转发', 'icon': IconFont.icon_zhuanfa}];
